...
export default function CtaProjetos() {
  return (
    <section className="relative py-28 bg-amber-950 overflow-hidden">
      ...
      {/* glow background */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,#C9A85A,transparent_60%)] opacity-20" />
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10 text-center">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-white leading-tight">
            Gostou dos nossos <span className="text-amber-400">projetos?</span>
          </h2>

          <p className="text-amber-100 mt-6 text-lg leading-relaxed max-w-2xl mx-auto">
            Transformamos ideias em obras reais com rigor técnico, segurança e excelência.
            Fale connosco e receba uma proposta personalizada para o seu projeto.
          </p>
        </motion.div>
        ...
        >
          Orçamento gratuito • Resposta rápida • Acompanhamento técnico especializado
        </motion.p>
